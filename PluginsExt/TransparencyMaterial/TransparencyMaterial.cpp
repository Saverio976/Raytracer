...
namespace RayTracer::PluginsExt::Transparency {
    TransparencyMaterial::TransparencyMaterial(const Scenes::ISetting &config):
    ...
    Images::Color TransparencyMaterial::getNextColor(const Images::Ray &ray, const Entities::Transform::Vector3f &intersect, const Scenes::IDisplayable &displayable) const {
        Images::Color final(0, 0, 0, 255);
        std::vector<std::reference_wrapper<Images::Color>> list;
        list.push_back(final);
        Entities::Transform::Vector3f normal = ray.getDirection().getNormalized();
    ...
    Images::Color TransparencyMaterial::getColor(const Images::Ray &ray, const Entities::Transform::ITransform &centerObj, const Entities::Transform::Vector3f &intersect, const Scenes::IDisplayable &displayable) const
    {
    ...
    void TransparencyMaterial::setColor(const Images::Color &color)
    {
        _color = color;
    }

    Images::Color TransparencyMaterial::redirectionLight(const Images::Ray &ray, const Scenes::IDisplayable &displayable,
