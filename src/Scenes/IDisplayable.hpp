...
namespace RayTracer::Scenes {
    ...
    class IDisplayable {
        public:
             ...
             */
            virtual const std::vector<std::unique_ptr<Entities::ILight>> &getLightList() const = 0;
            /**
             * @brief Get the light list
             *
             * @return the light list
             */
            virtual std::vector<std::unique_ptr<Entities::ILight>> &getLightList() = 0;
            /**
             * @brief Get the primitive list (const)
             *
             * @return the primitive list
             */
            virtual const std::vector<std::unique_ptr<Entities::IPrimitive>> &getPrimitiveList() const = 0;
            /**
             * @brief Get the primitive list
             *
             * @return the primitive list
             */
            virtual std::vector<std::unique_ptr<Entities::IPrimitive>> &getPrimitiveList() = 0;
    };
}
